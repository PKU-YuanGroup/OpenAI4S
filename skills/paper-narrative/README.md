...
`npx openai4s-skills install paper-narrative --target claude` is the short form
of the same command.
...
`skills/paper-narrative/` out
(`unzip main.zip 'OpenAI4S-main/skills/paper-narrative/*'` unpacks only that
