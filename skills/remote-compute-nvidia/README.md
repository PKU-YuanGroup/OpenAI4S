...
`npx @pku-yuangroup/openai4s-skills install remote-compute-nvidia --target claude`
...
`skills/remote-compute-nvidia/` out
(`unzip main.zip 'OpenAI4S-main/skills/remote-compute-nvidia/*'` unpacks only
