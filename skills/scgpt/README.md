...
`npx @pku-yuangroup/openai4s-skills install scgpt --target claude` installs the
...
which is also the route to take on Windows: extract it and copy `skills/scgpt/`
out (`unzip main.zip 'OpenAI4S-main/skills/scgpt/*'` unpacks only that
