...
`npx @pku-yuangroup/openai4s-skills install remote-compute-ssh --target claude`
...
`skills/remote-compute-ssh/` out
(`unzip main.zip 'OpenAI4S-main/skills/remote-compute-ssh/*'` unpacks only that
