...
`npx @pku-yuangroup/openai4s-skills install evo2 --target claude` installs the
...
which is also the route to take on Windows: extract it and copy `skills/evo2/`
out (`unzip main.zip 'OpenAI4S-main/skills/evo2/*'` unpacks only that
