...
| `index-BYMHdbMG.js` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
| `index-CneXr-5F.css` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
