...
| `index-BkYshynN.js` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
| `index-M5l2Tl8v.css` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
