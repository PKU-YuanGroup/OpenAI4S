...
| [`deeplink.ts`](deeplink.ts) | `?artifact=&version_id=` parse/serialize/resolve. |
...
| [`files-index.test.ts`](files-index.test.ts) | 500-fixture first page 50, filters, cursor reset, stale project, array fallback. |
| [`files-index.ts`](files-index.ts) | artifact-index browse; TODO client fallback onto the array route. |
...
| [`ui.ts`](ui.ts) | Files grid, Viewer, `openViewer`, ⌘K/deep-link hit. |
