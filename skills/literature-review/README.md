...
`npx @pku-yuangroup/openai4s-skills install literature-review --target claude`
...
`skills/literature-review/` out
(`unzip main.zip 'OpenAI4S-main/skills/literature-review/*'` unpacks only that
