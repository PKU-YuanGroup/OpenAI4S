...
| 文件 | 职责 |
| --- | --- |
| [`SKILL.md`](SKILL.md) | 这份 runbook：hosted 与 self-hosted NIM 怎么选、输入怎么准备和 stage、`host.compute` 的 create → submit → 通知 → harvest 全流程、哪个 key 用在哪里、任务环境长什么样、跑砸了怎么办，以及结果在采信之前怎么验。 |
