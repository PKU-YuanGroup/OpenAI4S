...
`npx @pku-yuangroup/openai4s-skills install reaction-yield-estimation --target claude`
...
`skills/reaction-yield-estimation/` out
(`unzip main.zip 'OpenAI4S-main/skills/reaction-yield-estimation/*'` unpacks
