...
`npx openai4s-skills install audit-dataset --target claude` is the short form of
the same command.
...
`skills/audit-dataset/` out
(`unzip main.zip 'OpenAI4S-main/skills/audit-dataset/*'` unpacks only that
