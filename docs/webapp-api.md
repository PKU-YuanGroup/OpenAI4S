...
| `GET /artifacts/{aid}/table/export.csv` | Stage 9: `text/csv` body of the complete filtered set; metadata in `X-Artifact-Id`, `X-Version-Id`, `X-Checksum`, `X-Filtered-Rows`, `X-Approximate`. |
