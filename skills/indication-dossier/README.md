...
`npx @pku-yuangroup/openai4s-skills install indication-dossier --target claude`
...
`skills/indication-dossier/` out
(`unzip main.zip 'OpenAI4S-main/skills/indication-dossier/*'` unpacks only that
