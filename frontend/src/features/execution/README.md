...
| [`exec.test.ts`](exec.test.ts) | Notebook dock chrome: opening executed code removes the variable inspector; the snapshot is re-read on every open and after a finished cell. |
