...
- **🔬 36 bundled Skills** — GPU/model science Skills (AlphaFold2 · ESMFold2 · Boltz · Chai-1 · OpenFold3 · ProteinMPNN · ESM-2 · Evo2 · Borzoi · scGPT · scVI · DiffDock …), DataPro professional-dataset search, CUA cloud-computer delegation, retrosynthesis planning, and research-workflow Skills. Skills are **recipes of code**, not JSON schemas; user-authored Skills stay under the data directory and cannot shadow bundled trust.
...
| [**Skills**](docs/skills.md) | the 36 bundled Skills + how to write your own |
