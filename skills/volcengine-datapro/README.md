...
`npx openai4s-skills install volcengine-datapro --target claude` is the short
...
`skills/volcengine-datapro/` out
(`unzip main.zip 'OpenAI4S-main/skills/volcengine-datapro/*'` unpacks only that
