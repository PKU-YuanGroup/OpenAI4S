...
class RoadmapFeatureFlags:
    ...
    Every flag defaults off. Stage 1--9 consume only their own flags for
    ...
    and the Artifact workbench/Ketcher; later stages remain inert until
    their own Go/No-Go gate passes.
    """
