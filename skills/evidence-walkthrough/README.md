...
`npx @pku-yuangroup/openai4s-skills install evidence-walkthrough --target claude`
...
`skills/evidence-walkthrough/` out
(`unzip main.zip 'OpenAI4S-main/skills/evidence-walkthrough/*'` unpacks only
