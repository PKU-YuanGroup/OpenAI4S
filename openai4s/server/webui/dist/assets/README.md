...
| `index-COKZYIyZ.css` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
| `index-b9JZzQU9.js` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
