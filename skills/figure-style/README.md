...
`npx openai4s-skills install figure-style --target claude` is the short form of
the same command.
...
`skills/figure-style/` out
(`unzip main.zip 'OpenAI4S-main/skills/figure-style/*'` unpacks only that
