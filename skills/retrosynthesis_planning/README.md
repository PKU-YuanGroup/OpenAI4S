...
| [`SCENARIO.md`](SCENARIO.md) | Eight independently testable retrosynthesis domain problems, from disconnection and precursor generation through multi-step search, feasibility, conditions, route decisions, and evidence. |
| [`SCENARIO_zh.md`](SCENARIO_zh.md) | Chinese version of the retrosynthesis domain decomposition and per-subproblem solution/evaluation contract. |
