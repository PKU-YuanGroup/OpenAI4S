...
`npx openai4s-skills install figure-composer --target claude` is the short form
of the same command.
...
`skills/figure-composer/` out
(`unzip main.zip 'OpenAI4S-main/skills/figure-composer/*'` unpacks only that
