...
class SessionDeletionService:
    ...
    def __init__(
        ...
        *,
        ...
        # Stage 1 owns the global frameless-mutation/deletion barrier that makes
        # unlinking a shared uploads basename race-free. Older compositions do
        # not have that barrier, so their historical "leave for sweeper"
