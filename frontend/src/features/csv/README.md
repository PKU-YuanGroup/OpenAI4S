...
| [`csv.test.ts`](csv.test.ts) | Quoted-newline sample: three paths, same grid; a declared CSV is never sniffed as JSON; repeated headers and cells past the header keep their own columns. |
