...
`npx openai4s-skills install evaluate-model --target claude` is the short form
of the same command.
...
`skills/evaluate-model/` out
(`unzip main.zip 'OpenAI4S-main/skills/evaluate-model/*'` unpacks only that
