...
`npx openai4s-skills install reaction-condition-recommendation`.
...
unzip it and copy `skills/reaction-condition-recommendation/` out. If you
already run OpenAI4S there is nothing to install — the wheel ships every
bundled Skill, and a bundled Skill takes precedence over a same-named copy in
