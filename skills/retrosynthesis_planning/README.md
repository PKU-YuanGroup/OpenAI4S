...
`npx @pku-yuangroup/openai4s-skills install retrosynthesis_planning --target claude`
...
`skills/retrosynthesis_planning/` out
(`unzip main.zip 'OpenAI4S-main/skills/retrosynthesis_planning/*'` unpacks only
...
| [`gt_codebase.py`](gt_codebase.py) | Shared pure-stdlib installer, public-pipeline runtime, artifact freezer, and private evaluator dispatcher for the six separated Scenario codebases. |
