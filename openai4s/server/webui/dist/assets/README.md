...
| `index-BAVz5txJ.js` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
| `index-OGd4CwUf.css` | Vite build output. Do not edit by hand; rebuild from `frontend/`. |
