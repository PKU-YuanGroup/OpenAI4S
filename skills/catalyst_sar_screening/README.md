...
`npx @pku-yuangroup/openai4s-skills install catalyst_sar_screening --target claude`
...
`skills/catalyst_sar_screening/` out
(`unzip main.zip 'OpenAI4S-main/skills/catalyst_sar_screening/*'` unpacks only
