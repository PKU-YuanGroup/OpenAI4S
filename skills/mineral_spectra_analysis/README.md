...
`npx @pku-yuangroup/openai4s-skills install mineral_spectra_analysis --target claude`
...
`skills/mineral_spectra_analysis/` out
(`unzip main.zip 'OpenAI4S-main/skills/mineral_spectra_analysis/*'` unpacks only
